 ...
 *  set to nonzero. If @p state is zero, the returned string will be @c NULL terminated.
 *
 *  If @p str is @c NULL or @p n is zero, an empty string will be allocated and returned.
 *
 *  @param[in] parserState Pointer to the parser's json_parser_state instance
 ...
 *  @return Pointer to the allocated UTF-8 encoded string, or NULL on failure
 *
